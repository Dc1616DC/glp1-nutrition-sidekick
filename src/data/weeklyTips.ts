// Weekly motivational tips and intentions for GLP-1 users
export const WEEKLY_TIPS = [
  // Protein-focused tips
  "This week, aim to include a palm-sized portion of protein in every meal you eat.",
  "Focus on eating your protein first this week—it will help you stay satisfied longer.",
  "Try adding Greek yogurt, eggs, or lean meats to meals where you usually skip protein.",
  "Remember: 20-30g of protein per meal helps maximize your GLP-1 medication's effectiveness.",
  "This week, experiment with plant-based proteins like beans, lentils, or quinoa.",
  
  // Fiber and vegetables
  "Challenge yourself to add one extra serving of vegetables to your plate each day.",
  "This week, try to 'eat the rainbow'—include colorful vegetables in every meal.",
  "Fiber is your friend—aim for 4-6g per meal to support your digestive health.",
  "Start each meal with a few bites of vegetables to enhance satiety signals.",
  "This week, discover one new high-fiber food you've never tried before.",
  ...
  "This week, establish consistent meal times to optimize your medication timing.",
  ...
  "Progress isn't perfection—celebrate every small victory this week.",
  "This week, focus on how you feel rather than just what the scale says.",
  ...
  // Energy and mood
  "Notice how balanced meals affect your energy levels throughout the week.",
  "This week, pay attention to foods that make you feel vibrant and satisfied.",
  "Stable blood sugar leads to stable moods—fuel yourself consistently.",
  "This week, identify which meal combinations keep you energized longest.",
  "Remember: proper nutrition supports both your body and your mental clarity.",
  
  // Planning and preparation
  "This week, try preparing one component of your meals in advance.",
  "Planning ahead reduces decision fatigue—batch prep what you can.",
  "This week, keep healthy snacks visible and less nutritious options out of sight.",
  "Try meal planning for just 2-3 days ahead to reduce overwhelm.",
  "This week, identify your 'danger times' for cravings and plan alternatives.",
  ...
  // Symptom management
  "If you experience nausea, try eating smaller, more frequent meals this week.",
  "This week, identify foods that settle your stomach when you're feeling queasy.",
  "Remember: some GLP-1 side effects improve as your body adjusts to better habits.",
  "This week, track which foods make you feel your absolute best.",
  "Listen to your body—it's learning to work with your medication, not against it.",
  
  // Medication synergy
  "Your medication works best with consistent nutrition—make that your focus this week.",
  ...
  "This week, notice how your appetite naturally adjusts with proper meal timing.",
  ...
  "This week, focus on creating habits you can maintain for years, not just days.",
...
export const getWeeklyTip = (): string => {
  const now = new Date();
